...
Students will be evaluated on their knowledge of course content and their ability to communicate their understanding of the material via individual homework assignments (30%) and class participation (10%) as well as in a final test (60%). There will be 12 homework assignments, each of which will count toward 2.5% of the final grade. Please note, **all assignments must be turned in to achieve a passing grade**.

### Homework (30%)

The "homework" is due by 17:59 on the following Monday. It will consist of some small tasks and practical approaches based on topics covered. There will be 12 assignments worth 5% each.  Your learning in the class will be greatly enhanced by doing the "homework" which consist of applying the material you learn in each lecture to a data set.
...
The course concludes with a final test consisting of a “theoretical” section followed by a “practical” part (conducted on a computer). The questions in the test are structurally very similar to the content covered in the assignments, meaning that successfully completing the assignments almost guarantees passing the test.
