...
* `r xfun::embed_file('data/02_session/height.RData', text = "height.RData")`
* `r xfun::embed_file('data/02_session/kursmatrix.txt', text = "kursmatrix.txt")`
* `r xfun::embed_file('data/02_session/kursdata.txt', text = "kursdata.txt")`
* `r xfun::embed_file('data/02_session/kursdata.csv', text = "kursdata.csv")`
...
```{r}
scan("data/02_session/kursmatrix.txt")
```
...
```{r}
kursmatrix <- matrix(scan("data/02_session/kursmatrix.txt"),ncol=2)
```
...
```{r}
kursdata <- read.table("data/02_session/kursdata.txt")
```
...
```{r}
kursdata <- read.csv2("data/02_session/kursdata.csv")
kursdata
```
...
```{r}
kursdaten <- read.csv2("data/02_session/kursdata.csv",row.names = 1)
kursdaten
```
...
```{r}
load("data/02_session/height.RData")
height
```
