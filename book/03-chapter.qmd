...
```{r}
muensingen <- read.csv2("data/03_session/muensingen_fib.csv", row.names = 1)
...
par(mfrow=c(2,2))
smi <- read.csv("data/03_session/SSMI.csv", stringsAsFactors = F)
